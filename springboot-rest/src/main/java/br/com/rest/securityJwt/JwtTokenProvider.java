package br.com.rest.securityJwt;
...
import expections.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    private String getRefreshToken(String username, List<String> roles, Date now, Date validity) {
        Date validityRefreshToken = new Date(now.getTime() + (validityMilliseconds * 3)); // 3h
        return JWT.create()
                .withClaim("roles", roles)
                .withIssuedAt(now)
